...
/// 设备信息
@interface HN669DeviceInfo : NSObject
 ...
 * @author dayong
 */
@interface HN669UserExtraData : NSObject
...
@interface HN669Analytics : NSObject<IHN669Analytics>
